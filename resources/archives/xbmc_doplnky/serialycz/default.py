...
def getContent(session,params):
	...
	doplnkyprovider.DoplnkyMultiResolverContentProvider(serialy.SerialyczContentProvider(tmp_dir='/tmp'), settings, __addon__, session).run(params)
