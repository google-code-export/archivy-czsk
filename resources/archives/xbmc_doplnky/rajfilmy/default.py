...
def getContent(session, params):
    ...
    doplnkyprovider.DoplnkyMultiResolverContentProvider(rajfilmy.RajfilmyContentProvider(), settings, __addon__, session).run(params)
